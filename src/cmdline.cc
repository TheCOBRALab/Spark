...
const char *args_info_usage = "Usage: Spark"
                              "[options] [sequence]";
...
const char *args_info_help[] = {
    ...
    "  -k  --pk-only          Only add base pairs which cross the constraint structure. Return constraint if addition of base pairs is unfavorable",
...
void cmdline_parser_print_version(void) {
    printf("%s %s\n", (strlen(Spark_CMDLINE_PACKAGE_NAME) ? Spark_CMDLINE_PACKAGE_NAME : "Spark"), Spark_CMDLINE_VERSION);
...
static void clear_args(struct args_info *args_info) { FIX_UNUSED(args_info); }
...
void cmdline_parser_free(struct args_info *args_info) { cmdline_parser_release(args_info); }
...
int cmdline_parser(int argc, char **argv, struct args_info *args_info) { return cmdline_parser2(argc, argv, args_info); }
...
static int update_arg(void *field, char **orig_field, unsigned int *field_given, unsigned int *prev_given, char *value, const char *possible_values[],
                      const char *default_value, cmdline_parser_arg_type arg_type, int no_free, int multiple_option, const char *long_opt,
...
int cmdline_parser_internal(int argc, char **argv, struct args_info *args_info, const char *additional_error) {
    ...
    while (1) {
        ...
        case 'v': /* Turn on verbose output.  */
            ...
            if (update_arg(0, 0, &(args_info->verbose_given), &(local_args_info.verbose_given), optarg, 0, 0, ARG_NO, 0, 0, "verbose", 'v',
                           additional_error)) {
                goto failure;
            }
        ...
        case 'm': /* Represent candidate base pairs by square brackets.  */
            ...
            if (update_arg(0, 0, &(args_info->mark_candidates_given), &(local_args_info.mark_candidates_given), optarg, 0, 0, ARG_NO, 0, 0,
                           "mark-candidates", 'm', additional_error)) {
                goto failure;
            }
        ...
        case 'r': /* Specify restricted structure.  */
            ...
            if (update_arg(0, 0, &(args_info->input_structure_given), &(local_args_info.input_structure_given), optarg, 0, 0, ARG_NO, 0, 0,
                           "input-structure", 'r', additional_error)) {
                goto failure;
            }
        ...
        case 'i': /* Specify input file.  */
            ...
            if (update_arg(0, 0, &(args_info->input_file_given), &(local_args_info.input_file_given), optarg, 0, 0, ARG_NO, 0, 0, "input-file", 'i',
                           additional_error)) {
                goto failure;
            }
        ...
        case 'd': /* Specify dangle type for multiloop.  */
            ...
            if (update_arg(0, 0, &(args_info->dangles_given), &(local_args_info.dangles_given), optarg, 0, 0, ARG_NO, 0, 0, "dangles", 'd',
                           additional_error)) {
                goto failure;
            }
        ...
        case 'p': /* Predict a pseudoknot.  */
            ...
            if (update_arg(0, 0, &(args_info->pseudoknot_free_given), &(local_args_info.pseudoknot_free_given), optarg, 0, 0, ARG_NO, 0, 0,
                           "pseudoknot-free", 'p', additional_error)) {
                goto failure;
            }
        ...
        case 'P': /* Take in a different Parameter File.  */
            ...
            if (update_arg(0, 0, &(args_info->paramFile_given), &(local_args_info.paramFile_given), optarg, 0, 0, ARG_NO, 0, 0, "paramFile", 'P',
                           additional_error)) {
                goto failure;
            }
        ...
        case 0: /* Long option with no short option */
            ...
            if (strcmp(long_options[option_index].name, "noGC") == 0) {
                ...
                if (update_arg(0, 0, &(args_info->noGC_given), &(local_args_info.noGC_given), optarg, 0, 0, ARG_NO, 0, 0, "noGC", '-',
                               additional_error)) {
                    goto failure;
                }
            }
            if (strcmp(long_options[option_index].name, "noGU") == 0) {
                ...
                if (update_arg(0, 0, &(args_info->noGU_given), &(local_args_info.noGU_given), optarg, 0, 0, ARG_NO, 0, 0, "noGU", '-',
                               additional_error)) {
                    goto failure;
                }
            }
            ...
            if (strcmp(long_options[option_index].name, "noConv") == 0) {
                ...
                if (update_arg(0, 0, &(args_info->noConv_given), &(local_args_info.noConv_given), optarg, 0, 0, ARG_NO, 0, 0, "noConv", '-',
                               additional_error)) {
                    goto failure;
                }
            }
